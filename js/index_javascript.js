...
if(offsetWidth > 768){
  header.addEventListener('mouseenter', function(){
    ...
    document.querySelector('.header_menu h1 img.white_logo').style.display = 'none';
    document.querySelector('.header_menu h1 img.black_logo').style.display = 'inline-block';
    linkOnLinks.forEach(function(link) {
      link.style.color = 'var(--dark-black)';
    });
  ...
  header.addEventListener('mouseleave', function(){
    header.style.backgroundColor = '';
    document.querySelector('.header_menu h1 img.white_logo').style.display = 'inline-block';
    document.querySelector('.header_menu h1 img.black_logo').style.display = 'none';
    linkOnLinks.forEach(function(link) {
      link.style.color = '';
    });
